...
export const metadata: Metadata = {
  title: "MD Medical Services | Healthcare Services",
  description: "Explore MD Medical Services and access professional medical billing and claims-management support through MD Claims.",
};
